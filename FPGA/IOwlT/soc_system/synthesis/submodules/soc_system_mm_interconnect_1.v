...
module soc_system_mm_interconnect_1 (
	...
	wire  [105:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> dipsw_pio_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // dipsw_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire   [87:0] onchip_memory2_0_s1_agent_rp_data;                                          // onchip_memory2_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [87:0] router_007_src_data;                                                        // router_007:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [105:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                             // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	...
	wire  [105:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	soc_system_mm_interconnect_1_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
